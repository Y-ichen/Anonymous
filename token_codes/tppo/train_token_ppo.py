...
class ScriptArguments:
    ...
    reward_model_name: Optional[str] = field(default="token-rm-ckpt/checkpoint-260", metadata={"help": "the reward model name"})
    ...
    output_dir: Optional[str] = field(default="ckpt/token_ppo", metadata={"help": "n steps to save the model"})
    ...
    project_name: Optional[str] = field(default="token_ppo", metadata={"help": "wandb project name"})
